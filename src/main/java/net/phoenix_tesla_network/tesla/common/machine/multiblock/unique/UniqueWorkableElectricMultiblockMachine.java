package net.phoenix_tesla_network.tesla.common.machine.multiblock.unique;
...
import net.phoenix_tesla_network.tesla.saveddata.UniqueMultiblockSavedData;
...
public class UniqueWorkableElectricMultiblockMachine extends WorkableElectricMultiblockMachine {
    ...
    public void addDisplayText(@NotNull List<Component> textList) {
        if (this.isDuplicate) {
            textList.add(Component.translatable("phoenix_tesla_network.multiblock.duplicate.1")
                    .setStyle(Style.EMPTY.withColor(ChatFormatting.DARK_RED)));
            textList.add(Component.translatable("phoenix_tesla_network.multiblock.duplicate.2")
                    .setStyle(Style.EMPTY.withColor(ChatFormatting.DARK_RED)));
        } else {
